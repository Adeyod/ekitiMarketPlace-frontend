    ...
    product && (
      <div className="">
        <div className="grid grid-cols-2 gap-5">
                  ...
                  <img
                    ...
                    className={
                      ...
                      (selectedImageIndex === index
                        ? 'border-2 border-green-700 border-dotted p-2'
                        : '')
                    }
                    alt=""
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col">
              ...
              <div className="flex justify-between mt-2">
                ...
                <span>{product.freeDeliveryAvailable ? 'Yes' : 'No'}</span>
              </div>
            ...
            <div className="flex flex-col">
              ...
              {product.showBidsOnProductPage &&
                product.bids.map((bid) => {
                  return (
                    <div className="border border-solid border-gray-300 p-3 rounded mt-1">
          ...
          {/* <Divider />
          <div className="flex flex-col">
            <div className="flex justify-between">Bids</div>
          </div> */}
        </div>
        {showAddNewBid && (
          <BidModal
